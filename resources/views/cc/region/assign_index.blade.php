                                ...
                                <tbody>
                                    @foreach($users as $u)
                                        <tr>
                                            ...
                                            <td>{{ $u->supervisor ?? 'none' }}</td>
                                            <td class="text-end"><a class="btn btn-sm btn-outline-primary" href="{{ route('cc.region.assign', $u) }}">{{ $u->assignment ? 'Change Assignment' : 'Assign' }}</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
