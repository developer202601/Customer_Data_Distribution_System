        ...
        <nav class="nav flex-column cc-sidebar-nav">
            ...
            @else
                @if(\Illuminate\Support\Str::startsWith(session('user.assignment') ?? '', 'supervisor_'))
                    <a class="nav-link{{ $ccRouteName === 'cc.supervisor.dashboard' ? ' active' : '' }}" href="{{ route('cc.supervisor.dashboard') }}" aria-current="{{ $ccRouteName === 'cc.supervisor.dashboard' ? 'page' : '' }}">Dashboard</a>
                    <a class="nav-link{{ $ccRouteName === 'cc.management.index' ? ' active' : '' }}" href="{{ route('cc.management.index') }}" aria-current="{{ $ccRouteName === 'cc.management.index' ? 'page' : '' }}">User Management</a>
                @elseif(\Illuminate\Support\Str::startsWith(session('user.assignment') ?? '', 'caller_'))
