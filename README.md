...
- Laravel receives the ZIP uploads, performs header/structure validation, and writes all artifacts (archives, manifests, exports) under `storage/app/master-artifacts/{token}`.
