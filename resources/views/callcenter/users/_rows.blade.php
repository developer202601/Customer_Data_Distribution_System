...
@php
    ...
    if ($assignment === 'super') {
        ...
        $rtom = strtoupper(str_replace('rtom_', '', $assignment));
        $role = 'RTO Admin for ' . $rtom;
    } elseif (str_starts_with($assignment, 'supervisor_rtom_')) {
        $rtom = strtoupper(str_replace('supervisor_rtom_', '', $assignment));
        $role = 'Supervisor for RTO ' . $rtom;
    } elseif (str_starts_with($assignment, 'caller_rtom_')) {
        $rtom = strtoupper(str_replace('caller_rtom_', '', $assignment));
