...
CREATE TABLE `configuration_changes` (
  ...
  KEY `configuration_changes_configuration_id_index` (`configuration_id`),
  CONSTRAINT `configuration_changes_configuration_id_fk` FOREIGN KEY (`configuration_id`) REFERENCES `configurations` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2025_11_10_000001_reset_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_11_10_000002_create_sessions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2025_11_25_120000_create_dataset_exports_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2025_11_26_100000_create_master_dataset_tables',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2025_11_28_000000_add_python_pipeline_tables',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2025_11_21_120529_create_configuration_table',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2025_11_30_000003_create_configuration_changes_table',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2025_11_30_000004_remove_rowcount_from_master_dataset_processes',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2025_12_01_000500_add_metrics_columns_to_master_dataset_processes',7);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2025_12_01_081000_update_master_dataset_unique_key',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2025_12_16_000000_create_call_center_reports_table',9);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2025_12_16_000001_create_call_center_row_assignments_table',10);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2025_12_16_000002_create_call_center_interactions_table',10);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2025_12_17_000003_add_accept_reject_flags_to_call_center_row_assignments',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2025_12_17_000000_add_account_number_to_call_center_interactions',12);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2025_12_17_000004_add_payment_columns_to_call_center_row_assignments',13);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2025_12_17_000005_add_paid_amount_to_call_center_interactions',13);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2025_12_19_000004_add_reassignment_origin_to_call_center_row_assignments',14);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2026_02_10_000000_drop_legacy_configuration_table',15);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (23,'2026_02_10_000001_add_fk_configuration_changes_to_configurations',16);
